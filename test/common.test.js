...
describe("getAuthInfo", () => {
  ...
  it("should set and return new AuthInfo", async () => {
    jest.spyOn(xssec.XsuaaService.prototype, "fetchClientCredentialsToken").mockResolvedValueOnce("token");
  ...
  it("should not use cache if validity is below 60 seconds (margin)", async () => {
    jest.spyOn(xssec.XsuaaService.prototype, "fetchClientCredentialsToken").mockResolvedValue("token");
